...
$apart=$_POST['aadhar'];
 ...
 $query=mysqli_query($con,"insert into tblvisitor(VisitorName,MobileNumber,Address,Aadhar) value('$visname','$mobnumber','$add','$apart')");
...
<head>
    ...
    <!-- Title Page-->
    <title>PVSM Visitors Forms</title>
...
<body class="animsition">
    ...
    echo $msg;
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="mobilenumber" name="mobilenumber" placeholder="Mobile Number" class="form-control" maxlength="10" onkeypress="return isNumberKey(event)" required="true">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">Aadhar no.</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="apartment" name="aadhar" placeholder="Aadhar no." class="form-control"  required="true">
                                                    
                                                </div>
                                           <center>
                                                <span id="error_msg"  style="font-weight: bolder; color: red"></span>
                                            </center>
                                            <br><br>  
...
<script type="text/javascript">
    jQuery(document).ready(function () {
                       jQuery("#mobilenumber").keypress(function (e) {
                        ...
                        if(length > 9) {
                         $("#error_msg").text("Maximum reached");
                             return false;
                        } else if((length == 0) && (e.which == 48)) {
                         $("#error_msg").text("Enter");
                             return false;
                        }
                       });
    ...
    function isNumberKey(evt)
      ...
      jQuery(document).ready(function () {
                       jQuery("#apartment").keypress(function (e) {
                          var length = jQuery(this).val().length;
                        if(length > 11) {
                         $("#error_msg").text("Maximum reached");
                             return false;
